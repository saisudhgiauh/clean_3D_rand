# gen_data_ray_equivalent.py
# Ray-parallelized version that reproduces the physics and outputs of the sequential script
...
# Initialize Ray (safe to call multiple times)
...
# --- Fan out all Ray tasks ---

ray.init ()
ray.remote(memory=2_000_000_000)

output = chunk (run_angle, [(ba, polarisation_setting) for ba in bloch_angles])

ray.shutdown()
# --- Gather and print results ---
for r in ray.get(output):
    print(r)
